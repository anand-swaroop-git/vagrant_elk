...
sudo wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.10.0-amd64.deb > /dev/null 2>&1

echo -e "\e[1;32mDownload PGP Keys!\e[0m"
wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.10.0-amd64.deb.sha512 > /dev/null 2>&1
